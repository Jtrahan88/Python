...
def calculate_demographic_data(print_data=True):
    ...
    highest_earning_country = (country_rich_counts / country_count * 100).idxmax()
    highest_earning_country_percentage = round(country_rich_counts / country_count * 100,1).max()
